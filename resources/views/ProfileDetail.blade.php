                    ...
                    <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
                        ...
                        <div class="px-6 py-8">
                            <form action="{{ url('/profile/update') }}" method="POST">
                                ...
                                <div class="mt-8">
                                    <button type="submit" 
                                            class="w-full bg-[#E5CBA6] text-white font-medium py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                        Update Profile
                                    </button>
                                </div>
                            </form>
                            ...
                            <div class="mt-6 text-center">
                                <a href="/home" class="inline-flex items-center text-[#E5CBA6] hover:text-indigo-500 font-medium">
