<x-layout>
            ...
            @if (count($cart) > 0)
                    ...
                    <div class="cart-item">
                        ...
                        <div class="cart-item-quantity">
                            <div class="quantity-control">
                                <button class="quantity-btn" onclick="updateQuantity('{{ $item['menuDayId'] }}', -1)">−</button>
                ...
                <div class="cart-footer">
                    <div class="subtotal-container">
                        ...
                        <div class="subtotal-value">Rp. {{ number_format($totalPrice, 0, ',', '.') }}</div>
    ...
    <script>
        function updateQuantity(menuDayId, change) {
            // This is a placeholder for quantity update functionality
            // You would typically make an AJAX call to your server
            console.log('Update quantity for item', menuDayId, 'by', change);
            
            // For demo purposes, we'll just refresh the page
            // In a real implementation, you would update the cart via AJAX
