    ...
    <div class="bg-[#FFF8E6]">
        <section class="relative bg-[#E5CBA6] overflow-hidden font-[Inika] min-h-145">
            <div class="absolute top-0 left-0 w-full mt-8" style="height: 600px;">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 600" preserveAspectRatio="none" class="w-full h-auto">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-start md:items-start text-center md:text-left">
                <div class="md:w-1/2 text-center md:text-left flex flex-col justify-start items-center md:items-start">
                    <div>
                        <h1 class="text-4xl md:text-6xl font-bold text-[#3F2812]">Discovering Caterings Made Easier!</h1>
                        <p class=" md:text-3x1 mt-4 font-bold text-[#824C0F]">
                            Find new and tasty food all around you with ease! With NomNom, you can connect with your
                            favourite dishes; no matter where or when you are.
                        </p>
                    </div>
                    <button
                ...
                <div class="relative md:w-1/2 flex justify-center items-center mt-10 md:mt-0">
                    ...
                    <img src="{{ asset('images/HomeFood.png') }}" alt="Delicious Food"
                        class="w-[160px] h-[160px] absolute md:w-[460px] md:h-[460px] rounded-full object-cover z-10">
                </div>
            </div>
        </section>
