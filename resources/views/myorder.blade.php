        ...
        <div class="container mx-auto py-8 px-4 font-[Instrument Sans]">
            ...
            @else
                <div class="space-y-6">
                    ...
                    <div class="bg-[#FFF8E6] rounded-4xl p-6 mb-6" style="box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.15), 0px -2px 10px rgba(0, 0, 0, 0.1), -2px 10px 10px rgba(0, 0, 0, 0.1), 2px 10px 10px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-2">
                                    @foreach ($order['items'] as $item)
                                        <div class="flex justify-between items-center shadow-md bg-[#F4ECD8] p-3 mt-5">
