        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-center flex-col md:flex-row gap-6">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            ...
                                            <input type="tel" name="phone" id="phone"
                                                placeholder="Your Phone Number" value="{{ old('phone', $user->phone) }}"
                                                class="pl-10 pr-3 py-3 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-gray-900">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            ...
                                            <textarea name="address" id="address" placeholder="Your Address" rows="3"
                ...
                <div class="w-full max-w-2xl">
                    <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
                        ...
                        <!-- Form Content -->
                        <div class="px-6 py-8">
                            <form action="{{ route('vendor.restaurant.update') }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="space-y-6">
                                    <!-- Restaurant Name -->
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <div
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400"
                                                    viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd"
                                                        d="M6 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z"
                                                        clip-rule="evenodd" />
                                                </svg>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            ...
                                            <textarea name="restaurantAddress" id="restaurantAddress" placeholder="Restaurant Address" rows="3" required
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('VendorDashboard') }}"
                    class="inline-flex items-center text-[#E5CBA6] hover:text-[#d7bb93] font-medium">
